...
# @class_declaration community_sync_eg_motivosdevolucion #
class community_sync_eg_motivosdevolucion(interna_eg_motivosdevolucion, helpers.MixinConAcciones):
    pass
...
class eg_motivosdevolucion(community_sync_eg_motivosdevolucion, helpers.MixinConAcciones):
    pass
