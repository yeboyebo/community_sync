...
# @class_declaration community_sync_eg_lineasecommerceexcluidas #
class community_sync_eg_lineasecommerceexcluidas(interna_eg_lineasecommerceexcluidas, helpers.MixinConAcciones):
    pass
...
class eg_lineasecommerceexcluidas(community_sync_eg_lineasecommerceexcluidas, helpers.MixinConAcciones):
    pass
