...
# @class_declaration community_sync_eg_devolucionestienda #
class community_sync_eg_devolucionestienda(interna_eg_devolucionestienda, helpers.MixinConAcciones):
    pass
...
class eg_devolucionestienda(community_sync_eg_devolucionestienda, helpers.MixinConAcciones):
    pass
