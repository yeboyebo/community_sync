...
# @class_declaration community_sync_eg_cupones #
class community_sync_eg_cupones(interna_eg_cupones, helpers.MixinConAcciones):
    pass
...
class eg_cupones(community_sync_eg_cupones, helpers.MixinConAcciones):
    pass
