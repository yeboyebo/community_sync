...
# @class_declaration community_sync_idl_ecommercedevoluciones #
class community_sync_idl_ecommercedevoluciones(interna_idl_ecommercedevoluciones, helpers.MixinConAcciones):
    pass
...
class idl_ecommercedevoluciones(community_sync_idl_ecommercedevoluciones, helpers.MixinConAcciones):
    pass
