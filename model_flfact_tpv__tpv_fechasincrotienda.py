...
# @class_declaration community_sync_tpv_fechasincrotienda #
class community_sync_tpv_fechasincrotienda(interna_tpv_fechasincrotienda, helpers.MixinConAcciones):
    pass
...
class tpv_fechasincrotienda(community_sync_tpv_fechasincrotienda, helpers.MixinConAcciones):
    pass
