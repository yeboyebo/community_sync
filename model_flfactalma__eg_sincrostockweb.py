...
# @class_declaration community_sync_eg_sincrostockweb #
class community_sync_eg_sincrostockweb(interna_eg_sincrostockweb, helpers.MixinConAcciones):
    pass
...
class eg_sincrostockweb(community_sync_eg_sincrostockweb, helpers.MixinConAcciones):
    pass
