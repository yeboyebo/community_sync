...
# @class_declaration community_sync_eg_logtarjetasweb #
class community_sync_eg_logtarjetasweb(interna_eg_logtarjetasweb, helpers.MixinConAcciones):
    pass
...
class eg_logtarjetasweb(community_sync_eg_logtarjetasweb, helpers.MixinConAcciones):
    pass
