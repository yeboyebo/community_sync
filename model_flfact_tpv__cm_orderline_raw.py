...
from models.flfact_tpv.objects.eg_lineaecommerceexcluida_raw import EgLineaEcommerceExcluida


class CmOrderLine(AQModel):
    ...
    def get_children_data(self):
        if "lineaecommerceexcluida" in self.data["children"]:
            if self.data["children"]["lineaecommerceexcluida"]:
                self.children.append(EgLineaEcommerceExcluida(self.data["children"]["lineaecommerceexcluida"]))
