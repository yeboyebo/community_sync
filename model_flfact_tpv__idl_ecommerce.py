...
# @class_declaration community_sync_idl_ecommerce #
class community_sync_idl_ecommerce(interna_idl_ecommerce, helpers.MixinConAcciones):
    pass
...
class idl_ecommerce(community_sync_idl_ecommerce, helpers.MixinConAcciones):
    pass
