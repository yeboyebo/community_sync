...
# @class_declaration community_sync_eg_logpedidosweb #
class community_sync_eg_logpedidosweb(interna_eg_logpedidosweb, helpers.MixinConAcciones):
    pass
...
class eg_logpedidosweb(community_sync_eg_logpedidosweb, helpers.MixinConAcciones):
    pass
