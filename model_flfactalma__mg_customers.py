...
# @class_declaration community_sync_mg_customers #
class community_sync_mg_customers(interna_mg_customers, helpers.MixinConAcciones):
    pass
...
class mg_customers(community_sync_mg_customers, helpers.MixinConAcciones):
    pass
